...
describe('useTestState', () => {
  ...
  it('should set questions', () => {
    ...
    act(() => { result.current.actions.setQuestions(questions); });
  ...
  it('should load session data', () => {
    ...
    act(() => { result.current.actions.loadSession(sessionData); });
