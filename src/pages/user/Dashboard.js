      ...
      <main className="px-4 py-5 max-w-7xl mx-auto space-y-5">
        ...
        {isInstallable && (
          <motion.div
            ...
            className="bg-gradient-to-r from-blue-500 via-indigo-500 to-purple-500 rounded-2xl p-4 shadow-lg relative overflow-hidden"
          >
            ...
            <div className="relative flex items-center justify-between gap-3">
              <div className="flex items-center gap-3 flex-1 min-w-0">
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-white/70 text-xs truncate">Add to home screen for quick access</p>
                </div>
              </div>
              <motion.button
                whileHover={{ scale: 1.05 }}
                ...
                className="px-4 py-2 bg-white text-indigo-600 text-sm font-semibold rounded-xl hover:bg-indigo-50 transition-colors whitespace-nowrap shadow-lg"
              >
                Install
              </motion.button>
            </div>
