    ...
    >
      ...
      >
        <div className="flex justify-between items-center text-sm">
          ...
          <span
            className={`font-bold ${hasEnough ? 'text-green-700 dark:text-green-300' : 'text-amber-700 dark:text-amber-300'}`}
          >
...
const TestSelection = () => {
  ...
  const requiredQuestions = selectedExamPattern.sections.reduce(
          ...
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-xs md:text-sm text-gray-500 dark:text-gray-400">
                Choose your test type and exam
              </p>
            </div>
          ...
          {loading ? (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[1, 2, 3, 4].map((item) => (
                <div
                  key={item}
                  className="bg-gray-50 dark:bg-gray-700/50 rounded-2xl p-5 animate-pulse"
                >
