...
const PracticeMode = () => {
  ...
  useNavigationBlock(
    isTestInProgress,
    'You have an ongoing practice test. Your progress will be saved, but are you sure you want to leave?'
  );
  ...
  }, [clearSession, currentUser, examType, navigate, questions, recordTimeSpent, responses]);
          ...
          <div className="bg-gradient-to-r from-emerald-50 to-teal-50 dark:from-emerald-900/20 dark:to-teal-900/20 rounded-lg p-4 mb-4">
            <div className="grid grid-cols-2 gap-3 text-sm">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-gray-700 dark:text-gray-300">
                  <strong>No Timer</strong> - Go at your pace
                </span>
              </div>
              <div className="flex items-center gap-2">
                <svg
                ...
                <span className="text-gray-700 dark:text-gray-300">
                  <strong>+{Number(examPattern.sections[0].marksPerQuestion).toFixed(2)}</strong>{' '}
                  per correct
                </span>
              </div>
              <div className="flex items-center gap-2">
                ...
                <span className="text-gray-700 dark:text-gray-300">
                  <strong>{Number(examPattern.sections[0].negativeMarking).toFixed(2)}</strong> per
                  wrong
                </span>
              </div>
            </div>
          ...
          <div className="hidden md:flex justify-between items-center">
            <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Section: {currentSection?.name} &middot; Q{currentQuestionIndex + 1}/
                {questions.length}
              </p>
            </div>
          ...
          <div className="md:hidden">
            ...
            <div className="flex justify-center items-center bg-emerald-50 dark:bg-emerald-900/20 rounded-lg p-2">
              <span className="text-sm font-medium text-emerald-700 dark:text-emerald-300">
                No Time Limit - Practice at your pace
              </span>
            </div>
          </div>
        </div>
          ...
          <div className="lg:col-span-2 order-1" ref={questionCardRef}>
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 no-select">
              ...
              <div className="hidden md:flex flex-wrap gap-3">
                ...
                >
                  {currentResponse.markedForReview ? 'Marked for Review' : 'Mark for Review'}
                </button>
                <button
      ...
      {showExitModal && (
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-20">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl p-6 max-w-sm w-full">
            <h2 className="text-lg font-bold text-gray-800 dark:text-white mb-2">Exit Practice?</h2>
